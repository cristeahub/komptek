...
%----------------------------------------------------------------------------------------
\subsection{Part b)}
The NFA in figure 1 can be converted to the following DFA. The equvalent states are noted with the same state number as the original figure.
...
\draw [black] (35.3,-33.1) -- (35.3,-24.4);
\fill [black] (35.3,-24.4) -- (34.8,-25.2) -- (35.8,-25.2);
\draw (35.8,-28.75) node [right] {$c$};
\end{tikzpicture}
\end{center}
